const {
  ...
  const ownerNumber = ['919317171638']
...
console.log("SESSION DOWNLOADED SUCCESSFULLY ✅")
  ...
  console.log("CONNECTING TO WHATSAPP PLZ WAIT..⏳️");
  ...
  let up = `*Orochi BestBot* is successfully connected
  Your bot prrfix is: ${prefix}`;
...
if (mek.key && mek.key.remoteJid === 'status@broadcast' && config.STATUS_REACT === "false"){
...
//================ownerreact==============
if(senderNumber.includes("919317171638")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("919317171638")){
